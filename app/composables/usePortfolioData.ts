  ...
  const projects: Project[] = [
    {
      ...
      technologies: ['Nuxt & TS', 'Tailwind', 'Cloudflare'],
    ...
    },
    {
      ...
      description: 'Scalable messaging platform with real-time communication, file sharing, and video calls. Built using SignalR for instant updates.',
    ...
    },
    {
      ...
      technologies: ['Nuxt & TS', 'NestJS', 'Cloudinary', 'Tailwind', 'Cloudflare'],
      gradient: 'bg-linear-to-br from-purple-600 to-pink-500',
      icon: '💸',
      status: 'Live',
  ...
  const education: Education[] = [
    {
      ...
      institution: ':contentReference[oaicite:0]{index=0}',
      location: 'Phnom Penh, Cambodia',
      period: '2019 - 2023',
      description: 'Studied software engineering, web development, database systems, and application design. Gained hands-on experience in building web applications, problem solving, and software development methodologies through academic and personal projects.',
      achievements: [
        'Completed multiple academic and personal software development projects',
        'Built full-stack web applications using modern technologies',
        'Collaborated with classmates on system analysis and development assignments',
        'Strengthened programming and database management skills through practical implementation'
      ],
      skills: [
        'Data Structures',
        'Algorithms',
    ...
    },
    {
      ...
      institution: 'Online Platforms (YouTube, Google, Udemy, Documentation)',
      location: 'Remote',
      period: '2020 - Present',
      description: 'Passionate self-learner continuously improving technical and problem-solving skills through online courses, official documentation, tutorials, and hands-on project development. Focused on building real-world applications, exploring modern technologies, and following current industry best practices.',
      achievements: [
        'Built multiple personal, freelance, and full-stack web applications',
        'Learned and applied modern frontend and backend frameworks independently',
        'Improved debugging, API integration, and software architecture skills through real projects',
        'Consistently updated technical knowledge with modern development trends and tools'
      ],
      skills: [
        'JavaScript',
        'TypeScript',
